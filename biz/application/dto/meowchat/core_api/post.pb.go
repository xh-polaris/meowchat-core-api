...
type Post struct {
	...
	Likes      int64             `protobuf:"varint,11,opt,name=likes,proto3" json:"likes" form:"likes" query:"likes"`
	Comments   int64             `protobuf:"varint,12,opt,name=comments,proto3" json:"comments" form:"comments" query:"comments"`
}
...
type NewPostReq struct {
	...
	CoverUrl string   `protobuf:"bytes,4,opt,name=coverUrl,proto3" json:"coverUrl" form:"coverUrl" query:"coverUrl"`
...
var file_meowchat_core_api_post_proto_rawDesc = []byte{
	...
	0x66, 0x66, 0x69, 0x63, 0x69, 0x61, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x42, 0x83, 0x01, 0x0a, 0x25,
