...
type Plan struct {
	...
	User        *user.UserPreview `protobuf:"bytes,10,opt,name=user,proto3" json:"user,omitempty" form:"user" query:"user"`
...
type GetPlanPreviewsReq struct {
	...
	Keyword          *string                  `protobuf:"bytes,3,opt,name=keyword,proto3,oneof" json:"keyword,omitempty" form:"keyword" query:"keyword"`
	PaginationOption *basic.PaginationOptions `protobuf:"bytes,4,opt,name=paginationOption,proto3" json:"paginationOption,omitempty" form:"paginationOption" query:"paginationOption"`
}
...
type NewPlanReq struct {
	...
	MaxFish     *int64             `protobuf:"varint,10,opt,name=maxFish,proto3,oneof" json:"maxFish,omitempty" form:"maxFish" query:"maxFish"`
	ImageUrls   []string           `protobuf:"bytes,11,rep,name=imageUrls,proto3" json:"imageUrls,omitempty" form:"imageUrls" query:"imageUrls"`
	Summary     *string            `protobuf:"bytes,12,opt,name=summary,proto3,oneof" json:"summary,omitempty" form:"summary" query:"summary"`
	PlanState   *content.PlanState `protobuf:"varint,13,opt,name=planState,proto3,enum=meowchat.content.PlanState,oneof" json:"planState,omitempty" form:"planState" query:"planState"`
}
...
var file_meowchat_core_api_plan_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x83, 0x01, 0x0a, 0x25, 0x63, 0x6f, 0x6d,
