...
type NewPlanReq struct {
	...
	ImageUrls   []string          `protobuf:"bytes,8,rep,name=imageUrls,proto3" json:"imageUrls,omitempty" form:"imageUrls" query:"imageUrls"`
}
...
var file_meowchat_core_api_plan_proto_rawDesc = []byte{
	...
	0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x42, 0x4f,
