...
type Notification struct {
	...
	TargetType      NotificationTargetType `protobuf:"varint,5,opt,name=targetType,proto3,enum=meowchat.system.NotificationTargetType" json:"targetType" form:"targetType" query:"targetType"`
	Type            NotificationType       `protobuf:"varint,6,opt,name=type,proto3,enum=meowchat.system.NotificationType" json:"type" form:"type" query:"type"`
	Text            string                 `protobuf:"bytes,7,opt,name=text,proto3" json:"text" form:"text" query:"text"`
	CreateAt        int64                  `protobuf:"varint,8,opt,name=createAt,proto3" json:"createAt" form:"createAt" query:"createAt"`
	IsRead          bool                   `protobuf:"varint,9,opt,name=isRead,proto3" json:"isRead" form:"isRead" query:"isRead"`
}
...
var file_meowchat_system_common_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x64, 0x10, 0x03, 0x42, 0x82, 0x01, 0x0a, 0x24, 0x63, 0x6f, 0x6d, 0x2e, 0x78, 0x68,
	...
	0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x4b, 0x67,
	...
	0x68, 0x61, 0x74, 0x2f, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
